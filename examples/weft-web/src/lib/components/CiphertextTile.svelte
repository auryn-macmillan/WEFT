<script lang="ts">
  ...
  $: bgPattern = `
    radial-gradient(circle at ${seed % 100}% ${(seed * 7) % 100}%, var(--color-neutral-600) 1px, transparent 1px),
    radial-gradient(circle at ${(seed * 13) % 100}% ${(seed * 17) % 100}%, var(--color-neutral-700) 1px, transparent 1px),
    radial-gradient(circle at ${(seed * 23) % 100}% ${(seed * 29) % 100}%, var(--color-neutral-800) 1px, transparent 1px)
  `;
